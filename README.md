...
### Bangladesh Cheap Solar Scenario

A simulation of a large household in Dhaka, Bangladesh using low-cost polycrystalline panels and generic Chinese lead-acid batteries:
...
- **Battery:** 10 kWh generic lead-acid (45% usable, $60/kWh)
- **Inverter:** 4 kW
